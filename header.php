            ...
            <nav class="navbar navbar-expand-sm navbar-light m-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="./index.php#testi">Testimonials</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="digital_learning.php">Digital Learning</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link apply" href="student_registration.php">Student Registration</a>
                            </li>
                        </ul>
                    </div>
                </nav>
